...
<div class="row" style="margin-bottom: 20px;">
    ...
    <p style="border-top: 2px solid blue;"></p>
    <form method="GET" action="{{ route('tai-lieu.tim-kiem') }}">
        <div class="form-group row">
            <div class="col-md-4">
                <input type="text" name="tenMonHoc" placeholder="Nhập tên môn học cần tìm . . ." class="form-control">
            </div>
            <div class="col-md-4"><button type="submit" class="btn btn-success">Tìm kiếm</button></div>
        </div>
    </form>
</div>
