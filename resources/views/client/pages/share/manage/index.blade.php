    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="" style="float: right">
                <form action="{{ route('item.type.admin.find') }}" method="post" id="SendForm">
                    @csrf
                    <input type="text" class="form-control" id="Search" name="I_content" placeholder="Tìm kiếm từ khóa">
                </form>
            </div>
            <br><br>
